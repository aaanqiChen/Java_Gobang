...
public class ChooseFrame2 extends JFrame{
	private static final ChooseFrame2 instance=new ChooseFrame2();
	private ChooseFrame2() {
		setSize(300,400);
		...
		competbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dispose();
				ChessFrame3.getInstance().setVisible(true);
			}
		});
	...
	public static ChooseFrame2 getInstance() {
		return instance;
	}
}
